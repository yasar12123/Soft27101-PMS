...
class Ui_AddProjectDialog(object):
    ...
    def retranslateUi(self, AddProjectDialog):
        ...
        self.projectStatusCB.setItemText(0, _translate("AddProjectDialog", "Not Started"))
        self.projectStatusCB.setItemText(1, _translate("AddProjectDialog", "In-Progress"))
        ...
        self.exitProjectButton.setText(_translate("AddProjectDialog", "Exit"))
