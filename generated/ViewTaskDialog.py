...
class Ui_ViewTaskDialog(object):
    def setupUi(self, ViewTaskDialog):
        ...
        self.sendReviewtButton = QtWidgets.QPushButton(parent=self.groupBox_2)
        self.sendReviewtButton.setObjectName("sendReviewtButton")
        self.verticalLayout_2.addWidget(self.sendReviewtButton)
...
"")
    ...
    def retranslateUi(self, ViewTaskDialog):
        ...
        self.taskStatusCB.setItemText(4, _translate("ViewTaskDialog", "Review Failed"))
