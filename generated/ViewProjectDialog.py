...
class Ui_ViewProjectDialog(object):
    def setupUi(self, ViewProjectDialog):
        ...
        ViewProjectDialog.resize(480, 686)
        self.verticalLayout = QtWidgets.QVBoxLayout(ViewProjectDialog)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=ViewProjectDialog)
        self.groupBox_2.setTitle("")
        self.groupBox_2.setObjectName("groupBox_2")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.groupBox_2)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.newCommentTE = QtWidgets.QTextEdit(parent=self.groupBox_2)
        self.newCommentTE.setObjectName("newCommentTE")
        self.verticalLayout_4.addWidget(self.newCommentTE)
        self.addCommentButton = QtWidgets.QPushButton(parent=self.groupBox_2)
        self.addCommentButton.setObjectName("addCommentButton")
        self.verticalLayout_4.addWidget(self.addCommentButton)
    ...
    def retranslateUi(self, ViewProjectDialog):
        ...
        self.addCommentButton.setText(_translate("ViewProjectDialog", "Add comment"))
        self.groupBox_3.setTitle(_translate("ViewProjectDialog", "Comments Timeline"))
